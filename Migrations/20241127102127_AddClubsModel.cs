...
{
    /// <inheritdoc />
    public partial class AddClubsModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdPlayerWhite = table.Column<int>(type: "int", nullable: false),
                    IdPlayerBlack = table.Column<int>(type: "int", nullable: false),
                    IdTour = table.Column<int>(type: "int", nullable: false),
                    GameResult = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RatingWhite = table.Column<double>(type: "float", nullable: false),
                    RatingBlack = table.Column<double>(type: "float", nullable: false),
                    RatingWhiteChange = table.Column<double>(type: "float", nullable: false),
                    RatingBlackChange = table.Column<double>(type: "float", nullable: false),
                    DidTheGamePassed = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinksUser", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPlayer = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdUser = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RatingClassic = table.Column<double>(type: "float", nullable: false),
                    RatingRapid = table.Column<double>(type: "float", nullable: false),
                    RatingBlitz = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnlineOrOffline = table.Column<int>(type: "int", nullable: false),
                    ...
                    CountTours = table.Column<int>(type: "int", nullable: false),
                    IsInProgress = table.Column<bool>(type: "bit", nullable: false),
                    MinimumYearOfBirth = table.Column<int>(type: "int", nullable: false),
                    MaxRating = table.Column<int>(type: "int", nullable: false),
                    MaxCountOfPlayers = table.Column<int>(type: "int", nullable: false),
                    IsTheTournamentHeldUsingThePlatform = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdPlayerSkippingGame = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
